...
public class Task {
    ...
    private String attachmentPath; // path ke file lampiran (disimpan di folder data/attachments)
    private String attachmentName; // nama asli file, untuk ditampilkan ke user
